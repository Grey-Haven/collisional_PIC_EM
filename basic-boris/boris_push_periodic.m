...
if (size(particles_in_domain,1) ~= 0)
    ...
    newLocation = pushParticle(xe,ve,dt); % should probably be newVelocity
...
function E = evalE(Ex_padded,Ey_padded,Ez_padded,loc,x,y,z,...
    ...
    E1 = gather_field_periodic(Ex_padded,loc,x_padded,y,z_padded,dx,dy,dz,...
                               Ex_stagger_x,Ex_stagger_y,Ex_stagger_z,...
    ...
    E2 = gather_field_periodic(Ey_padded,loc,x,y_padded,z_padded,dx,dy,dz,...
                               Ey_stagger_x,Ey_stagger_y,Ey_stagger_z,...
                               0,0,1,... 
                               a_x,a_y,a_z,b_x,b_y,b_z);
...
%                       0,0,0,...
%                       a_x,a_y,a_z,b_x,b_y,b_z);
    B3 = gather_field_periodic(Hz_padded,loc,x_padded,y_padded,z_padded,dx,dy,dz,...
                               Hz_stagger_x,Hz_stagger_y,Hz_stagger_z,...
                               0,0,1,...
                               a_x,a_y,a_z,b_x,b_y,b_z);
    B1 = zeros(size(B3));
