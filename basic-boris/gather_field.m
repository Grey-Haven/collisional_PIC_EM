function F_p = gather_field(F,loc,x,y,z,dx,dy,dz,...
...
%     try
    ...
    idx2 = sub2ind(size(F),isPlusOne,js,ks);
    idx3 = sub2ind(size(F),is,jsPlusOne,ks);
    idx4 = sub2ind(size(F),isPlusOne,jsPlusOne,ks);
    idx5 = sub2ind(size(F),is,js,ksPlusOne);
    idx6 = sub2ind(size(F),isPlusOne,js,ksPlusOne);
    idx7 = sub2ind(size(F),is,jsPlusOne,ksPlusOne);
    idx8 = sub2ind(size(F),isPlusOne,jsPlusOne,ksPlusOne);    
